...
in_bc = api.Dirichlet(name='in_vel', material=fluid)
in_bc.data[CUBA.VARIABLE] = CUBA.VELOCITY
...
for node in lat.iter():
    ...
    if node.data[CUBA.MATERIAL] == fluid and ijk[2] == 0:
        node.data[CUBA.VELOCITY] = (0, 0, ana_vel[ijk[0]-1])
    else:
...
# ---------------------------------------------------------------------------
# Post-processing: error and output
# ---------------------------------------------------------------------------
